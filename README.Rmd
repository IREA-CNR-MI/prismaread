...
of a PRISMA L1 hdf5 image, an output file name and format, and a series of switches
...
This latter functionality may be only appliable/make sense to "HRC" L1 data cubes. 
